...
export interface JobExtractionResult {
  title: string;
  category: string;              // Subcategory name that AI selected
  ...
  categoryConfidence?: number;    // How confident AI is about the category
  alternativeCategories?: string[]; // Other categories AI considered
  skillsRequired?: string[];      // Technical skills extracted
